...
export default function PassWay() {
    ...
    <>
      ...
      >
        ...
        <section className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden pt-20 md:pt-24">
          ...
          {/* Content - now properly layered above overlays */}
          <div className="container mx-auto px-4 sm:px-6 relative z-20 text-center text-white">
            ...
            >
              ...
              <h1 className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-black leading-tight mb-4 md:mb-8">
              ...
              <span className="block text-4xl sm:text-5xl md:text-6xl lg:text-7xl mt-2 md:mt-4 text-orange-400 drop-shadow-2xl font-bold">
                رحلتك اليومية…
              </span>

              <p className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-black mt-8 md:mt-12 mb-8 md:mb-12">
              ...
              <p
                className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl max-w-4xl mx-auto mb-10 md:mb-16 font-medium leading-relaxed px-4"
